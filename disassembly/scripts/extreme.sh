...
OUTPUT=${PWD}/result/
qsub -o ./logfiles/short_extreme.log -j y ./scripts/disassembly.job  \
        ${ROOT}/short_extreme/mock_genome_ref.fa \
        ${ROOT}/short_extreme/reads.fa \
        ${OUTPUT}/short_extreme/

qsub -o ./logfiles/middle_extreme.log -j y ./scripts/disassembly.job \
        ${ROOT}/middle_extreme/mock_genome_ref.fa \
        ${ROOT}/middle_extreme/reads.fa \
        ${OUTPUT}/middle_extreme/

qsub -o ./logfiles/long_extreme.log -j y ./scripts/disassembly.job \
