...
OUTPUT=${PWD}/result/
qsub -o ./logfiles/short_hard.log -j y ./scripts/disassembly.job \
     ${ROOT}/short_hard/mock_genome_ref.fa \
     ${ROOT}/short_hard/reads.fa \
     ${OUTPUT}/short_hard/ 2

qsub -o ./logfiles/middle_hard.log -j y ./scripts/disassembly.job \
     ${ROOT}/middle_hard/mock_genome_ref.fa \
     ${ROOT}/middle_hard/reads.fa \
     ${OUTPUT}/middle_hard/ 2

qsub -o ./logfiles/long_hard.log -j y ./scripts/disassembly.job \
