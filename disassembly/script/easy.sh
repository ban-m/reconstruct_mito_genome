...
OUTPUT=${PWD}/result
qsub -o ./logfiles/short_easy.log -j y ./script/disassembly.job  \
     ${ROOT}/short_easy/mock_genome_ref.fa \
     ${ROOT}/short_easy/reads.fa \
     ${OUTPUT}/short_easy 2 

qsub -o ./logfiles/middle_easy.log -j y ./script/disassembly.job \
     ${ROOT}/middle_easy/mock_genome_ref.fa \
     ${ROOT}/middle_easy/reads.fa \
     ${OUTPUT}/middle_easy 2 

qsub -o ./logfiles/long_easy.log -j y ./script/disassembly.job\
