...
# qsub -sync yes ./script/run_workflow.job \
#      ~/work/arabidopsis_mitochondria/create_simulation_data/data/easy/mock_genome_read.fa \
#      ${PWD}/result/easy_simulated_genome/ \
#      ~/work/arabidopsis_mitochondria/create_simulation_data/data/easy/mock_genome_ref.fa
